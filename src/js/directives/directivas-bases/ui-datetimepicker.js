/**
 * Directiva encargaa del manejo de fecha y hora
 * https://github.com/adamalbrecht/ngQuickDate
 * @class
 * @name master.directive.Datetimepicker
 * @author <>
 */
/*
 * Se define el modulo de  directiva
 */
angular.module("datetimepicker", [])

.provider("ngQuickDateDefaults", function () {
    return {
        options: {
            dateFormat: 'd/M/yyyy',
            timeFormat: 'h:mm a',
            ...
            defaultTime: null,
            dayAbbreviations: ["Dom", "Lun", "Ma", "Mi\u00e9", "Jue", "Vie", "S\u00e1b"],
            dateFilter: null,
...
.config(function (ngQuickDateDefaultsProvider) {
    ...
    return ngQuickDateDefaultsProvider.set({
        closeButtonHtml: "<i class='icon-times icon-large'></i>",
        // buttonIconHtml: "<button class='btn btn-search btn-sm' type='button'> <div class='icon-calendar icon-large'></div></button>",

        buttonIconHtml: "<i class='icon-calendar icon-large'></i>",
        nextLinkHtml: "<i class='icon-chevron-right icon-large'></i>",
        prevLinkHtml: "<i class='icon-chevron-left icon-large'></i>",
