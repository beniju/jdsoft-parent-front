angular.module('ui-duallistbox', []);

angular.module('ui-duallistbox')
    .directive('uiDuallistbox', function($compile, $timeout) {
        return {
            restrict: 'A',
            require: 'ngModel',
            link: function link(scope, element, attrs, controller) {
                ...
                var attributes = {
                    ...
                    'infoAll': {
                        ...
                        defaultValue: 'Mostrando {0}'
                    },
                    'infoFiltered': {
                        changeFn: 'setInfoTextFiltered',
                        defaultValue: '<span class="label label-warning">Filtrado</span> {0} de {1}'
                    },
                    'infoEmpty': {
                        changeFn: 'setInfoTextEmpty',
                        defaultValue: 'Lista vacía'
                    }
                };
