/**
 * file reader es un componente ayuda a facilitar la lectura de archivos en una aplicación.
 *
 * @class
 ...
 */
    ...
    var app = angular.module('uiFileReader', []);

    app.directive("uiFileReader", function () {
