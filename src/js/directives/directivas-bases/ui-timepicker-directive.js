/**
 * Esta directiva se encarga de las horas
 * Un selector de horas totalmente personalizable.
 * <a href ="http://angular-ui.github.io/bootstrap/#/timepicker</a>
 *
 * @class
 * @name master.directive.timepicker
 * @author <>
 */
...
.controller('TimepickerController', ['$scope', '$attrs', '$parse', '$log', '$locale', 'timepickerConfig',
    function ($scope, $attrs, $parse, $log, $locale, timepickerConfig) {
        ...
        //modifica el estado de $scope.readonlyInput
