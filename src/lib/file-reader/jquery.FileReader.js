(function ($) {
    ...
    $.fn.fileReader.defaults = {
        ...
        label: null,
        extensions: null,
        filereader: '/master/lib/filereader.swf', // The path to the filereader swf file
    ...
    window.FileAPIProxy = {
        ...
        init: function (o) {
            ...
            swfobject.embedSWF(o.filereader, o.id, '100%', '100%', '10', o.expressInstall, {debugMode: o.debugMode ? true : ''}, {
                'wmode': 'transparent',
    ...
    window.FileReader.prototype = {
        ...
        _start: function (file) {
            this._register(file);
            if (this.readyState === this.LOADING) throw {
