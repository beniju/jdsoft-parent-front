...
!function () {
    ...
    if (window.XMLHttpRequest && (window.FormData ? window.XMLHttpRequest = function (a) {
        return function () {
            var b = new a;
    ...
    }(window.XMLHttpRequest) : (window.XMLHttpRequest = function (b) {
        return function () {
            var c = new b, d = c.send;
            return c.__requestHeaders = [], c.open = function (a) {
                return c.upload || (c.upload = {}), c.__listeners = [], c.upload.addEventListener = function (a, b) {
                    c.__listeners[a] = b
                }, function (b, d, e) {
    ...
    }(window.XMLHttpRequest), window.XMLHttpRequest.__hasFlash = a()), window.XMLHttpRequest.__isShim = !0), !window.FormData) {
        var b = function (b) {
            if (!a())throw'Adode Flash Player need to be installed. To check ahead use "FileAPI.hasFlash"';
            if (!b.__isWrapped && (null != b.getAttribute("ng-file-select") || null != b.getAttribute("data-ng-file-select"))) {
                ...
                var d = b.parentNode;
                d.insertBefore(c, b), d.removeChild(b), c.appendChild(b), b.__isWrapped = !0
            }
        }, c = function (a) {
            return function (b) {
        ...
        HTMLInputElement.prototype.addEventListener && (HTMLInputElement.prototype.addEventListener = function (a) {
            return function (e, f, g, h) {
                d(this, e) ? (b(this), a.apply(this, [e, c(f), g, h])) : a.apply(this, [e, f, g, h])
            }
            ...
            return function (e, f) {
                d(this, e) ? (b(this), a.apply(this, [e, c(f)])) : a.apply(this, [e, f])
            }
            ...
            if (window.FileAPI || (window.FileAPI = {}), !FileAPI.upload) {
                window.FileAPI.jsUrl = '/master/lib/file-upload/FileAPI.min.js';
                window.FileAPI.flashUrl = '/master/lib/file-upload/FileAPI.flash.swf'
