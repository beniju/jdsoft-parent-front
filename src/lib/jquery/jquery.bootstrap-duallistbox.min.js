...
!function (a, b, c, d) {
    ...
    var u = "bootstrapDualListbox", v = {bootstrap2Compatible: !1, filterTextClear: "Ver todo", filterPlaceHolder: "Filtro", moveSelectedLabel: "Move selected", moveAllLabel: "Move all", removeSelectedLabel: "Remove selected", removeAllLabel: "Remove all", moveOnSelect: !0, moveOnDblClick: !0, preserveSelectionOnMove: !1, selectedListLabel: !1, nonSelectedListLabel: !1, helperSelectNamePostfix: "_helper", selectorMinimalHeight: 100, showFilterInputs: !0, nonSelectedFilter: "", selectedFilter: "", infoText: "Showing all {0}", infoTextFiltered: '<span class="label label-warning">Filtrado</span> {0} de {1}', infoTextEmpty: "Lista vacía", filterOnValues: !1}, w = /android/i.test(navigator.userAgent.toLowerCase());
    ...
    }, setMoveOnDblClick: function (a, b) {
        if (w && (a = !0), this.settings.moveOnDblClick = a, this.settings.moveOnDblClick) {
            this.container.addClass("moveondblclick");
            var c = this;
            this.elements.select1.dblclick("change", function () {
                p(c)
            }), this.elements.select2.dblclick("change", function () {
                q(c)
            })
        } else this.container.removeClass("moveondblclick"), this.elements.select1.off("change"), this.elements.select2.off("change");
        return b && k(this), this.element
