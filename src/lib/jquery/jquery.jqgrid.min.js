...
/*var synchronousRequestRefreshToken = function(Auth) {
			if (isTokenExpired(5)) {
	            ...
	            try {
	                ...
	                var url = Auth.authz.authServerUrl+ '/realms/' + Auth.authz.realm+'/tokens/refresh';
        ...
        var isTokenExpired = function(minValidity) {
				...
				case "script":
					$.ajax($.extend({
						...
						error:function(xhr,st,err){
							...
							MasterUtils.redirectError(estado);
							/**/
						},
						beforeSend: function(xhr, settings ){
							// var auth = window.authFactory;
							// if (MasterUtils.synchronousRequestRefreshToken(auth)) {
							// 		xhr.setRequestHeader('Authorization', 'Bearer ' + auth.authz.token);
       //                          	xhr.setRequestHeader('usuario', auth.authz.idTokenParsed.preferred_username);                         

       //                              var gotoreq = true;
							// 		//codigo original jqgrid
		...
		.append("<span class='icon icon-chevron-up'></span>").css({"right": "5px", "top": "15px"}) : "";
				...
				$(".ui-jqgrid-titlebar-close",grid.cDiv).click( function(e){
					...
					if(ts.p.gridstate === 'visible') {
						$(elems,"#gbox_"+$.jgrid.jqID(ts.p.id)).slideUp("fast", function() {
							counter--;
							if (counter === 0) {
								$("span",self).removeClass("icon-chevron-up").addClass("icon-chevron-down");
						...
						$(elems,"#gbox_"+$.jgrid.jqID(ts.p.id)).slideDown("fast", function() {
							counter--;
							if (counter === 0) {
								$("span",self).removeClass("icon-chevron-down").addClass("icon-chevron-up");
